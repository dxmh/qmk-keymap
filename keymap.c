...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM] = LAYOUT(
    ...
    KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, MO(FN1), XXXXXXX, HM_4,    HM_5,    HM_6,    HM_0,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MO(FN2), XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX,
                               _______, _______, _______, _______
  ),
  [NAV] = LAYOUT(
    XXXXXXX, KC_HOME, KC_UP,   KC_END,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    HM_PNKY, HM_LEFT, HM_DOWN, HM_RGHT, XXXXXXX, XXXXXXX, KC_LGUI, KC_LCTL, KC_LSFT, KC_LALT,
